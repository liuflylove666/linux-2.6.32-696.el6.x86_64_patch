 ...
 */
int
ip_vs_normal_response_xmit(struct sk_buff *skb, struct ip_vs_conn *cp, 
			   struct ip_vs_protocol *pp, int ihl)
{
	/* copy-on-write the packet before mangling it */
...
int
ip_vs_normal_response_xmit_v6(struct sk_buff *skb, struct ip_vs_conn *cp,
			      struct ip_vs_protocol *pp, int ihl)
{
	/* copy-on-write the packet before mangling it */
	if (!skb_make_writable(skb, ihl))
 ...
 */
int
ip_vs_fnat_response_xmit(struct sk_buff *skb, struct ip_vs_conn *cp,
			 struct ip_vs_protocol *pp, int ihl)
{
	struct rtable *rt;	/* Route to the other host */
	int mtu;
...
int
ip_vs_fnat_response_xmit_v6(struct sk_buff *skb, struct ip_vs_conn *cp,
			    struct ip_vs_protocol *pp, int ihl)
{
	struct rt6_info *rt;	/* Route to the other host */
	int mtu;
